...
import { mockProducts, searchProducts, filterProducts, filterProductsAdvanced, getProductSpecificationValues, getProductDetails, getProductWithDefaultItem } from './app/models/product';
import { mockItems, getItemsByProduct, getAvailableSpecificationValues, findItemBySpecificationValues, getDefaultItem, validateSpecificationValues, getItemsBySpecificationName } from './app/models/item';
...
// Test getItemsBySpecificationName
const itemsBySpec = getItemsBySpecificationName('prod_3');
console.log(`- Items grouped by specifications: ${Object.keys(itemsBySpec).join(', ')}\n`);
