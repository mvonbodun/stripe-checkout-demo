...
export const mockCategories: Category[] = [
  // Level 1 Categories
  {
    ...
    imageUrl: 'https://placehold.co/300x200/e5e7eb/6b7280?text=Electronics',
  ...
  },
  {
    ...
    order: 2,
    status: Status.ACTIVE,
    imageUrl: 'https://placehold.co/300x200/e5e7eb/6b7280?text=Clothing',
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  ...
  },
  {
    ...
    order: 3,
    status: Status.ACTIVE,
    imageUrl: 'https://placehold.co/300x200/e5e7eb/6b7280?text=Home+Garden',
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  ...
  },
  {
    ...
    order: 4,
    status: Status.ACTIVE,
    imageUrl: 'https://placehold.co/300x200/e5e7eb/6b7280?text=Sports+Outdoors',
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  ...
  },
  {
    ...
    order: 5,
    status: Status.ACTIVE,
    imageUrl: 'https://placehold.co/300x200/e5e7eb/6b7280?text=Books',
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01'),
  ...
  // Level 2 Categories - Electronics
  {
    ...
    order: 1,
    status: Status.ACTIVE,
    imageUrl: 'https://placehold.co/300x200/e5e7eb/6b7280?text=TVs+Audio',
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01')
  },
  {
    ...
    order: 2,
    status: Status.ACTIVE,
    imageUrl: 'https://placehold.co/300x200/e5e7eb/6b7280?text=Computers',
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01')
  },
  {
    ...
    order: 3,
    status: Status.ACTIVE,
    imageUrl: 'https://placehold.co/300x200/e5e7eb/6b7280?text=Mobile+Devices',
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-01-01')
  },
